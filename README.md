...
| --- | --- | --- | ---: | --- |
| kw906 | app | 0.1.82 | 1.3 MB | `kw906/app-0.1.82-25cbc85f.bin` |
| kw906 | app | 0.1.81 | 1.3 MB | `kw906/app-0.1.81-7e0dc22c.bin` |
| kw906 | app | 0.1.80 | 1.3 MB | `kw906/app-0.1.80-edc0ec80.bin` |
